/*
  THIS USES QUOKKA VALUE EXPLORER PLUGIN IN VSCODE
*/
...
// TEMPLATE LITERALS
const summary = `${title} is a book, a ${pages}-page long book, was written by ${author} and published in ${getYear(publicationDate)}. The book has ${hasMovieAdaptation ? "" : "not"} been adapted as a movie.`
summary;
...
// REDUCE
const pagesAllBooks = books.reduce((sum, book) => sum + book.pages, 0) // 0 is starting value
pagesAllBooks
